...
dl = downloads_path + r"\MODEL.ICE.HAD187001-198110.OI198111-202203.nc.gz"
print("Grabbing data...")

print(dl)
ds = xr.open_dataset(dl)  # open saved data
